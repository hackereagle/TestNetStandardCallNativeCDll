...
TEST(TestDllFunction, TestUsingCommonTypeNotUsingExternCOutput) 
{
	// arrange
	int arg1 = 1;
	double arg2 = 2.0;
	...
	double output2 = 0.0;
	float output3 = 0;
	UsingCommonTypeNotUsingExtrentC(arg1, arg2, arg3, &output1, &output2, &output3);

	// assert
	EXPECT_EQ(output1, arg1 + 4);
	EXPECT_DOUBLE_EQ(output2, arg2 + 5.0);
	EXPECT_EQ(output3, arg3 + 6);
}
